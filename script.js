...
function setup() {
  ...
  // load idle images
  idleImg1 = createImg(
    "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2FP1_Idle.gif?v=1580578684764"
  );
  idleImg2 = createImg(
    "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2FP2_Idle.gif?v=1580578684764"
  );

  // load jump images, and make sure they do not display
  jumpImg1 = createImg(
    "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2FFighter_P1_Jump.gif?v=1580860847142"
  );
  jumpImg2 = createImg(
    "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2FFighter_P2_Jump.gif?v=1580861430655"
  );
  jumpImg1.remove();
  jumpImg2.remove();

  // load ready button image
  readyButton = createImg(
...
function startTimer() {
  ...
  */
  ...
  if (currentHP1 <= 0 && currentHP2 <= 0) {
    ...
    restartButton = createImg(
      "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2Fbutton_play-again.png?v=1586904545517"
    );
  ...
  // game is not over yet - handle end of turn
    ...
    // check if iceberg crush cooldown should be reset
...
function drawMeleeIcon() {
  meleeIcon = createImg(
    "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2Fmelee_icon.png?v=1585697930465"
  );
}

// draws the Ranged Icon
function drawRangedIcon() {
  rangedIcon = createImg(
    "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2Franged_icon.png?v=1585697945658"
  );
}
...
function drawOtherIcon() {
  otherIcon = createImg(
    "https://cdn.glitch.com/3c8bb0ef-34b4-4b1b-8044-7b2c1b6c0326%2Fother_icon.png?v=1585697948579"
  );
}
...
function interpretCommands() {
  ...
  {
      setTimeout(function() { sounds[i].play(); }, i * 500);
  }
  */
